...
function main() {
  ...
  async function loadAll() {
    const fileInfos = [
      {
        name: "women&non-binary",
        hueRange: [0.9, 1.1],
        url: "assets/data/gpw_v4_basic_demographic_characteristics_rev10_a000_014ft_2010_cntm_1_deg.asc",
      },
      {
        name: "men",
        hueRange: [0.7, 0.3],
        url: "assets/data/gpw_v4_basic_demographic_characteristics_rev10_a000_014mt_2010_cntm_1_deg.asc",
      },
    ];
